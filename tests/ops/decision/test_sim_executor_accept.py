...
def test_sim_executor_accept_filled():
    executor = SimExecutor()
    ctx = ExecutionContext(trading_enabled=True, kill_switch=False)

    # ✅ ExecutionHint의 확장 슬롯은 constraints
    ...
    assert res.audit["simulation"]["result"] in ("FILLED", "PARTIAL")
