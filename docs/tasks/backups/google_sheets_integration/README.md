...
QTS 시스템의 핵심 데이터 레이어인 Google Sheets 9개 시트 연동 기능을 구현합니다. 스키마 관리 기반은 완료되었으나, 실제 Google Sheets와의 데이터 연동이 누락된 상태로 이를 해결하여 시스템의 데이터 영속성 기능을 활성화합니다.
...
- `src/runtime/data/repositories/` (9개 리포지토리)
