# Engine Layer — 진입점 및 Wiring

Phase 4 Engine Layer: 생성자 시그니처·ETEDA 연동·execute I/O 계약 정리.  
**근거**: [docs/arch/02_Engine_Core_Architecture.md](../../../docs/arch/02_Engine_Core_Architecture.md), [04_Data_Contract_Spec.md](../../../docs/arch/04_Data_Contract_Spec.md)
...
- **ETEDARunner** (`src/runtime/pipeline/eteda_runner.py`):  
