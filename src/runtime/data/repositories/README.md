...
9-Sheet Data Layer 리포지토리 구현. docs/arch/00_Architecture.md 및 04_Data_Contract_Spec.md 기준.
...
| **용도** | Position, History, Dividend, DI_DB, DT_Report, Strategy 등 Raw 데이터 시트 | Portfolio, Performance 등 대시보드/KPI 시트 |
| **예시** | PositionRepository, HistoryRepository, DI_DBRepository, StrategyRepository | EnhancedPortfolioRepository, EnhancedPerformanceRepository |
...
| DI_DB | DI_DBRepository | Base |
| DT_Report | DT_ReportRepository | Base |
