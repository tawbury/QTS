...
def _build_config_entries_from_env() -> List[ConfigEntry]:
    ...
    env_mappings = [
        ...
        # Allocation
        ("ALLOCATION_OVERRIDE_ENABLED", "SYSTEM", "ALLOCATION", "ALLOCATION_OVERRIDE_ENABLED", "1"),
        ("BALANCED_SCALP_PCT", "SYSTEM", "ALLOCATION", "BALANCED_SCALP_PCT", "0.40"),
        ("BALANCED_SWING_PCT", "SYSTEM", "ALLOCATION", "BALANCED_SWING_PCT", "0.35"),
        ("BALANCED_PORTFOLIO_PCT", "SYSTEM", "ALLOCATION", "BALANCED_PORTFOLIO_PCT", "0.25"),
        ("AGGRESSIVE_SCALP_PCT", "SYSTEM", "ALLOCATION", "AGGRESSIVE_SCALP_PCT", "0.70"),
        ("AGGRESSIVE_SWING_PCT", "SYSTEM", "ALLOCATION", "AGGRESSIVE_SWING_PCT", "0.22"),
        ("AGGRESSIVE_PORTFOLIO_PCT", "SYSTEM", "ALLOCATION", "AGGRESSIVE_PORTFOLIO_PCT", "0.08"),
        ("DEFENSIVE_SCALP_PCT", "SYSTEM", "ALLOCATION", "DEFENSIVE_SCALP_PCT", "0.10"),
        ("DEFENSIVE_SWING_PCT", "SYSTEM", "ALLOCATION", "DEFENSIVE_SWING_PCT", "0.20"),
        ("DEFENSIVE_PORTFOLIO_PCT", "SYSTEM", "ALLOCATION", "DEFENSIVE_PORTFOLIO_PCT", "0.70"),
    ]
